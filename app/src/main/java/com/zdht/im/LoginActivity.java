...
public class LoginActivity extends AppCompatActivity {
    ...
    private void initForLogin() {
        // 实例化登陆进度提示封装类
        onLoginProgress = new OnLoginProgress(LoginActivity.this);
        ...
        new LocalUDPDataSender.SendLoginDataAsync(
            ...
            protected void fireAfterSendLogin(int code) {
                if (code == 0) {
                    ...
                    Toast.makeText(getApplicationContext(), "数据发送失败。错误码是：" + code + "！", Toast
                            .LENGTH_SHORT).show();
...
//			versionName = info.versionName;
    ...
    private class OnLoginProgress {
        ...
        public OnLoginProgress(LoginActivity parentActivity) {
